import { frontendLessonsA } from './frontend.lessons-a.ts'
import { frontendLessonsB } from './frontend.lessons-b.ts'
import { frontendLessonsC } from './frontend.lessons-c.ts'
